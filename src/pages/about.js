        ...
        <main className='flex w-full flex-col items-center justify-center'>
            <Layout className='pt-16'>
                ...
                <div className='grid w-full grid-cols-8 gap-16'>
                    ...
                    <div className='col-span-3 relative h-min rounded-2xl border-2 border-solid border-dark bg-light p-8'>
                        <div className='absolute top-0 -right-3 -z-10 w-[102%] h-[102%] bg-dark
                                        rounded-[2rem] rounded-br-2xl'/>
                        <Image src={ProfilePic} alt="Eduard Tiron" className='w-full h-auto rounded-2xl' />
                    </div>
